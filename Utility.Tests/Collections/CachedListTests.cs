...
namespace Utility.Tests.Collections
{
    [TestFixture]
    public class CachedListTests
    {
        ...
        public void ConvertEmpty()
        {
            ...
            conversionTest(new Match[] { }, "Match[]");
        }
        ...
        public void ConvertNullElement()
        {
            ...
            conversionTest(new Regex[] { null }, "Null Regex");
        }
        ...
        public void ConvertOneElement()
        {
            ...
            conversionTest(new Regex[] { new Regex("abcd") }, "Regex[]");
        }
        ...
        public void ConvertTwoElements()
        {
            ...
            conversionTest(new Regex[] { new Regex("abcd"), new Regex("(a|b)") }, "Regex[]");
        }
        ...
        public void ConvertManyElements()
        {
            ...
            conversionTest(threeLetterStrings.Select(s => new Regex(s)).ToArray(), "Regex[]");
        }
